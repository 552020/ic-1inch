...
GREET_RESULT=$(dfx canister call limit_order greet '("LOP")')
echo "Result: $GREET_RESULT"

# Test 2: Get system stats
echo "📊 Test 2: Get system stats..."
STATS_RESULT=$(dfx canister call limit_order get_system_stats)
...
LIST_RESULT=$(dfx canister call limit_order get_active_orders)
