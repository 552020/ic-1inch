...
# Generate unique order data (following 1inch API format)
TIMESTAMP=$(date +%s)
...
SALT="$TIMESTAMP"  # Use timestamp for unique salt
SIGNATURE="0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef12"
EXTENSION="0x"
QUOTE_ID="test-quote-$TIMESTAMP"  # Use timestamp for unique quote ID
